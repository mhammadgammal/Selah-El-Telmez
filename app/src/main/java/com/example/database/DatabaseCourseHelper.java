...
public class DatabaseCourseHelper extends SQLiteOpenHelper {
    private static final String  NAME = "dbcourse.db";
    ...
    public DatabaseCourseHelper(@Nullable Context context) {
