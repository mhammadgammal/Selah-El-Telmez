...
public class DiscreteCourseHelper extends SQLiteOpenHelper {
    private static final String  NAME = "discretecourse.db";
    private static final String TABLE_NAME = "DISCRETE_TABLE"
            , COLUMN_LECTURE_ID = "ID"
            , COLUMN_LECTURE_NAME = "lec_name"
            , COLUMN_LECTURE_LINK = "lec_link";
    public DiscreteCourseHelper(@Nullable Context context) {
