...
public class OOPCourseHelper extends SQLiteOpenHelper {
    private static final String  NAME = "oopcourse.db";
    private static final String TABLE_NAME = "OOP_TABLE"
            , COLUMN_LECTURE_ID = "ID"
            , COLUMN_LECTURE_NAME = "lec_name"
            , COLUMN_LECTURE_LINK = "lec_link";
    public OOPCourseHelper(@Nullable Context context) {
