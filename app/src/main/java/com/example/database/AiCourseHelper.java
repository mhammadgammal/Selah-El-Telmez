...
public class AiCourseHelper extends SQLiteOpenHelper {
    private static final String  NAME = "aicourse.db";
    private static final String TABLE_NAME = "AI_TABLE"
            , COLUMN_LECTURE_ID = "ID"
            , COLUMN_LECTURE_NAME = "lec_name"
            , COLUMN_LECTURE_LINK = "lec_link";
    public AiCourseHelper(@Nullable Context context) {
