...
public class LACourseHelper extends SQLiteOpenHelper {
    private static final String  NAME = "lacourse.db";
    private static final String TABLE_NAME = "LA_TABLE"
            , COLUMN_LECTURE_ID = "ID"
            , COLUMN_LECTURE_NAME = "lec_name"
            , COLUMN_LECTURE_LINK = "lec_link";
    public LACourseHelper(@Nullable Context context) {
