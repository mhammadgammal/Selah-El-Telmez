...
public class ORCourseHelper extends SQLiteOpenHelper {
    private static final String  NAME = "orcourse.db";
    private static final String TABLE_NAME = "OR_TABLE"
            , COLUMN_LECTURE_ID = "ID"
            , COLUMN_LECTURE_NAME = "lec_name"
            , COLUMN_LECTURE_LINK = "lec_link";
    public ORCourseHelper(@Nullable Context context) {
