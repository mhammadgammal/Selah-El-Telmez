...
public class ArchiCourseHelper extends SQLiteOpenHelper {
    private static final String  NAME = "archicourse.db";
    private static final String TABLE_NAME = "ARCHI_TABLE"
            , COLUMN_LECTURE_ID = "ID"
            , COLUMN_LECTURE_NAME = "lec_name"
            , COLUMN_LECTURE_LINK = "lec_link";
    public ArchiCourseHelper(@Nullable Context context) {
