...
public class DsCourseHelper extends SQLiteOpenHelper {
    private static final String  NAME = "dscourse.db";
    private static final String TABLE_NAME = "DATAS_TRUCTURE_TABLE"
            , COLUMN_LECTURE_ID = "ID"
            , COLUMN_LECTURE_NAME = "lec_name"
            , COLUMN_LECTURE_LINK = "lec_link";
    public DsCourseHelper(@Nullable Context context) {
